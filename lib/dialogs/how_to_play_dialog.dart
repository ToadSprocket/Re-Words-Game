// dialogs/how_to_play_dialog.dart
...
class HowToPlayDialog {
  static void show(BuildContext context) {
    final sizes = GameLayout.of(context).sizes; // Get sizes from parent context
    showDialog(
      context: context,
            ...
            child: Column(
              ...
              children: [
                      ...
                      Row(
                        ...
                        children: [
                          LetterSquareComponent(
                            tile: Tile(letter: 'A', value: 1, isExtra: false),
                            sizes: sizes, // Pass sizes
                          ),
                          const SizedBox(width: 4.0),
                          LetterSquareComponent(
                            tile: Tile(letter: 'G', value: 2, isExtra: true),
                            sizes: sizes, // Pass sizes
                          ),
                        ],
                      ),
                ...
                ElevatedButton(
                  ...
                  style: AppStyles.buttonStyle(dialogContext),
